...
class AuditorFrontend:
    ...
    def render_header(self):
        ...
        st.markdown(
            f'<div class="main-header">🔍 {t("app_title")}</div>',
    ...
    def render_quick_stats(self):
        ...
        st.metric(
            t("completed"),
            completed_jobs,
            f"{t('failed')}: {total_jobs - completed_jobs}",
        )
    ...
    def render_run_view(self):
        ...
        st.markdown(
            f'<div class="view-header">🏃 {t("run")} - {t("job_queue")}</div>',
            unsafe_allow_html=True,
        )
    ...
    def render_findings_view(self):
        ...
        st.markdown(
            '<div class="view-header">🔍 Findings - Karty Niezgodności</div>',
            unsafe_allow_html=True,
        )
        ...
        with col3:
            date_filter = st.date_input(
                "Data od", value=datetime.now() - timedelta(days=30), key="date_filter"
            )
    ...
    def render_exports_view(self):
        ...
        st.markdown(
            '<div class="view-header">📤 Exports - PBC/WP/Raporty</div>',
            unsafe_allow_html=True,
        )
