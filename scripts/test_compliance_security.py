...
def test_user_manager():
    ...
    senior_user = user_manager.create_user(
        username="test_senior", email="senior@test.com", role=UserRole.SENIOR
    )
...
def test_audit_logger():
    ...
    test_user = type(
        "MockUser",
        (),
        {"id": "test_user_id", "username": "test_user", "role": UserRole.AUDITOR},
    )()
...
def test_access_control():
    ...
    test_user = type("MockUser", (), {"id": "owner_123", "role": UserRole.AUDITOR})()
...
def test_compliance_manager():
    ...
    user = compliance.create_user(
        username="compliance_test", email="compliance@test.com", role=UserRole.AUDITOR
    )
    ...
    # Test authorization
    assert (
        compliance.authorize_action(user, "resource_123", "view") == False
