...
from core.ocr_processor import OCRProcessor, OCRResult
...
def test_amount_parsing():
    ...
    try:
        ...
        for amount_str, expected_amount, expected_currency in test_cases:
            ...
            ), f"Amount parsing failed for '{amount_str}': got {amount}, expected {expected_amount}"
            if expected_currency:
                assert (
                    currency == expected_currency
                ), f"Currency parsing failed for '{amount_str}': got {currency}, expected {expected_currency}"
