...
from core.pdf_indexer import InvoiceData, PDFIndexer
...
def test_pop_matching():
    ...
    try:
        ...
        normalized_vendor = matcher._normalize_vendor_name(
        ...
        similarity = matcher._calculate_seller_similarity(
    ...
    try:
        ...
        try:
            args = cli.parser.parse_args(
                ["--demo", "--file", str(test_file), "--dry-run"]
            )
