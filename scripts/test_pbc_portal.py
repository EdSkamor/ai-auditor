...
from core.pbc_portal import PBCPortal, AssignmentType, AssignmentStatus, TaskStatus
...
def test_pbc_portal():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        updated_assignment = portal.get_assignment(assignment.id)
        updated_item = next(item for item in updated_assignment.pbc_items if item.id == pbc_item.id)
        ...
        print(f"   Completed items: {stats['completed_items']}/{stats['total_pbc_items']}")
