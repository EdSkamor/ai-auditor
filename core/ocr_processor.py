...
class OCRProcessor:
    ...
    def process_pdf_with_ocr(self, pdf_path: Path, output_dir: Optional[Path] = None) -> Dict[str, Any]:
...
def process_pdf_with_ocr(pdf_path: Path, output_dir: Optional[Path] = None) -> Dict[str, Any]:
