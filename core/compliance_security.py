...
from .exceptions import AuditError, SecurityError
...
class AuditLogger:
    ...
    def log_event(
        ...
        try:
            ...
            self.logger.info(
                f"Audit event logged: {event_type.value} by {user.username}"
            )
            return event
...
class AccessControlManager:
    ...
    def create_access_control(
        ...
        resource_type: str,
        owner_id: str,
        permissions: Dict[UserRole, List[str]] = None,
    ) -> AccessControl:
        ...
        try:
            ...
            with sqlite3.connect(self.db_path) as conn:
                ...
                """,
                    (
                        ...
                        json.dumps({k.value: v for k, v in permissions.items()}),
                        access_control.created_at.isoformat(),
                        access_control.modified_at.isoformat(),
            ...
            self.logger.info(
                f"Access control created for {resource_type}: {resource_id}"
            )
...
class ComplianceManager:
    ...
    def create_user(
        ...
        try:
            user = self.user_manager.create_user(
                username, email, role, permissions, security_level
            )
    ...
    def authenticate_user(
        self, username: str, ip_address: str = "127.0.0.1", user_agent: str = "Unknown"
    ) -> Optional[User]:
    ...
    def get_audit_trail(
        ...
        try:
            return self.audit_logger.get_events(
                user_id, None, start_date, end_date, limit
            )
        except Exception as e:
    ...
    def get_compliance_summary(self) -> Dict[str, Any]:
        ...
        try:
            ...
            for event in recent_events:
                ...
                events_by_security_level[security_level] = (
                    events_by_security_level.get(security_level, 0) + 1
                )
            ...
            return {
                ...
                "active_policies_count": len(
                    [p for p in self.security_policies if p.is_active]
                ),
