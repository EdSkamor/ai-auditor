...
class LocalAIAssistant:
    ...
    def __init__(self, config_path: Path):
        ...
        if HAS_AI_LIBS:
            ...
            self.logger.warning(
                "AI libraries not available. Install: pip install torch transformers sentence-transformers chromadb"
            )
    ...
    def _initialize_models(self):
        ...
        try:
            ...
            self.llm_tokenizer = AutoTokenizer.from_pretrained(
                f"meta-llama/{llm_config['model']}", trust_remote_code=True
            )
            ...
            self.vector_db = chromadb.PersistentClient(path=str(Path("data/vector_db")))
...
Answer:"""
    ...
    def _retrieve_relevant_documents(self, question: str, top_k: int = 5) -> List[str]:
        ...
        try:
            ...
            results = collection.query(
                query_embeddings=question_embedding.tolist(), n_results=top_k
            )
    ...
    def is_ready(self) -> bool:
        ...
        return (
            ...
            and self.vector_db is not None
        )
