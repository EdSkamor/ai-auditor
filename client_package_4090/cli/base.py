...
class BaseCLI:
    ...
    def _setup_common_args(self) -> None:
        ...
        self.parser.add_argument(
            "--debug", action="store_true", help="Enable debug mode with full traces"
        )
        self.parser.add_argument("--config", type=Path, help="Configuration file path")
        self.parser.add_argument(
            "--output-dir",
            "-o",
            type=Path,
    ...
    def run(self, args: Optional[List[str]] = None) -> int:
        ...
        try:
            ...
            return self._handle_exception(
                e, getattr(self, "_current_args", argparse.Namespace())
            )
